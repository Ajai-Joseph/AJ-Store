...
class SellChats extends StatefulWidget {
  const SellChats({Key? key}) : super(key: key);

  @override
  State<SellChats> createState() => _SellChatsState();
}

class _SellChatsState extends State<SellChats> with SingleTickerProviderStateMixin {
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
          return EmptyStateWidget(
            ...
            message: 'Buyers will appear here when they message you about your products',
          );
        }

        final filteredChats = snapshot.data!.docs
